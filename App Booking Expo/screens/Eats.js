                ...
                >
                    ...
                    <View style={{ marginTop: SIZES.radius }}>
                        <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>
                            Take trips at any time, choose how you want to travel, where you want to go and what you want to eat!
                        </Text>
                    </View>
                </View>
            ...
            <View style={{ flex: 1.5 }}>
                ...
                <View style={{ marginTop: SIZES.padding, paddingHorizontal: SIZES.padding }}>
                    ...
                    <Text style={{ marginTop: SIZES.radius, color: COLORS.gray, ...FONTS.body3 }}>
                        Traveling offers a multitude of advantages. It broadens your horizons, exposing you to different cultures, languages, and experiences. It fosters personal growth, building confidence and independence. Moreover, it provides an escape from routine, allowing you to relax, unwind, and create lifelong memories.
                    </Text>
                </View>
            </View>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ flex: 1, marginHorizontal: SIZES.padding, justifyContent: 'center' }}>
                            <Text style={{ ...FONTS.h1 }}>$299.89</Text>
                        </View>
